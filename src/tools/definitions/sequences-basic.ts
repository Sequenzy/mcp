    ...
    inputSchema: {
      ...
      properties: {
        ...
        nodeId: {
          type: "string",
          description:
            "action_email step nodeId from get_sequence. The node must belong to sequenceId. Do not pass an action_ab_test node; inspect its full variant bodies with get_ab_test.",
        },
        recipients: {
          type: "array",
          minItems: 1,
